...
public class FunctionalGraphBD<NodeType, EdgeType extends Number>
    implements FunctionalGraph<NodeType, EdgeType>, GraphADT<NodeType, EdgeType> {
  protected int cost;
  protected int edges;
  protected Hashtable<Integer, NodeType> mapping;
  ...
  @Override
  public List<NodeType> shortestPathData(Object start, Object end) {
    PackageCenterBD t2 = new PackageCenterBD(1, "place1");
    PackageCenterBD three = new PackageCenterBD(3, "St.Louis");
    if (start.equals(t2) && end.equals(three)) {
      ArrayList<PackageCenterBD> t = new ArrayList<PackageCenterBD>();
      t.add(t2);
      t.add(three);
      return (List<NodeType>) t;
    }
    return null;
  }
  ...
  @Override
  public void readGraph(EdgeType[][] data,Hashtable<Integer, NodeType> mapping) {
    // TODO Auto-generated method stub
  ...
  public FunctionalGraph generateMST() {
    // TODO Auto-generated method stub
    return null;
  }
  ...
  public List<NodeType> getAllNodes() {
    PackageCenterBD one = new PackageCenterBD(1, "Chicago");
    PackageCenterBD three = new PackageCenterBD(3, "St.Louis");
    ArrayList<PackageCenterBD> t = new ArrayList<PackageCenterBD>();
    t.add(one);
    t.add(three);
